...
CONFIGS = [
    ...
    (4,   2e-3,    8,   96,   32,  [1,1,1,1],     0.20),
    (5,   3e-3,    8,   96,   32,  [1,1,1,1],     0.20),

    # ── Batch size sweep ──
    (6,   1e-3,    4,   96,   32,  [1,1,1,1],     0.20),
    (7,   1e-3,   16,   96,   32,  [1,1,1,1],     0.20),
    (8,   1e-3,   32,   96,   32,  [1,1,1,1],     0.20),

    # ── Patch size sweep ──
    (9,   1e-3,    8,   64,   32,  [1,1,1,1],     0.20),
    (10,  1e-3,    8,  128,   32,  [1,1,1,1],     0.20),
    (11,  1e-3,    8,  160,   32,  [1,1,1,1],     0.20),

    # ── Model width sweep ──
    (12,  1e-3,    8,   96,   16,  [1,1,1,1],     0.20),
    (13,  1e-3,    8,   96,   48,  [1,1,1,1],     0.20),
    (14,  1e-3,    8,   96,   64,  [1,1,1,1],     0.20),

    # ── Encoder depth sweep ──
    (15,  1e-3,    8,   96,   32,  [2,2,2,2],     0.20),
    (16,  1e-3,    8,   96,   32,  [2,2,4,4],     0.20),
    (17,  1e-3,    8,   96,   32,  [2,2,4,8],     0.20),

    # ── SSIM weight sweep ──
    (18,  1e-3,    8,   96,   32,  [1,1,1,1],     0.00),
    (19,  1e-3,    8,   96,   32,  [1,1,1,1],     0.10),
    (20,  1e-3,    8,   96,   32,  [1,1,1,1],     0.30),
    (21,  1e-3,    8,   96,   32,  [1,1,1,1],     0.50),

    # ── Promising combinations ──
    (22,  1e-3,   16,  128,   48,  [2,2,2,2],     0.20),  # bigger everything
    (23,  5e-4,    8,  128,   64,  [2,2,4,4],     0.25),  # deep + large patches
    (24,  1e-3,    8,   96,   48,  [2,2,4,8],     0.20),  # deep + medium width
    (25,  5e-4,   16,   96,   32,  [2,2,2,2],     0.15),  # stable lr + depth
]
